...
export const categories: Category[] = [
  ...
  { id: 'cat-confectionery', name: 'Confectionery', gstRate: 18, description: 'Chocolates, candies and sweets', imageUrl: 'https://images.unsplash.com/photo-1548907040-4baa419e997d?w=200', skuCount: 58 },
